...
(function () {
    ...
    pinker.render = function (options = {}) {
        ...
        for (let i = 0; i < pinkerElements.length; i++) {
            ...
            switch (pinkerElement.tagName) {
                case "PRE":
                    renderFromPre(pinkerElement, options);
                    break;
                default:
                    displayError("unknown tag skipped (id:" + pinkerElement.id + ")");
                    break;
            }
        }
    };
        ...
        create: function () {
            return {
                ...
                draw: function (point, areaMinX, areaMaxX, context) {
                    context.fillStyle = pinker.config.textColor;
                    context.strokeStyle = pinker.config.textColor;
    ...
    const ArrowTypes = {
        ...
        convert: function (sourceArrow) {
            ...
            switch (sourceArrow) {
                ...
                case "1N":
                case "N1":
                    return this.barTriTail;
                case "0N":
                case "N0":
                    return this.circleTriTail;
            }
            ...
            switch (sourceArrow) {
                ...
                case "D":
                    return this.hollowArrow;
                case "o":
                    return this.hollowDiamond;
                case "+":
                    return this.filledDiamond;
                case "1":
    ...
    function makeSiblingNodesUniformSizes(allNodes) {
        ...
        nodesByWidth.sort(function (a, b) {
            return b.relativeArea.width - a.relativeArea.width;
        }); //sort into descending width order
        ...
        nodesByHeight.sort(function (a, b) {
            return b.relativeArea.height - a.relativeArea.height;
